...
> | 항목                                | 재판정                                                                                                                                                                                                                |
> | ----------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
> | [BR-012](#br-012)                   | **해소됨 — 단, 요청한 방식이 아니다.** member 자격을 «공급»한 게 아니라 board 계약을 없애 전부 member 로 통일했다. 관리 API 는 호출 가능해졌지만 **독립 로그인 자체가 사라졌다** → 후속은 BR-036                      |
...
| [BR-012](#br-012) | 독립 로그인에서 설정 API용 member 자격 획득   | 해소됨(요청과 다른 방식 — board 계약 폐지 @ ebff9af)  | 독립 로그인 소멸 → 후속 BR-036         |
